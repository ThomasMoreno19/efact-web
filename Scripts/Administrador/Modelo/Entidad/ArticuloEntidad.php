...
class Articulo
{
  ...
  //Constructor
  public function __construct(int $id, int $id_rubro, int $id_empresa, string $nombre, int $precio, bool $aparece_en_csv, bool $creado_en_pagina, string $logo_url = 'Archivos/Logos/Vacio.png')
  {
    $this->id = $id;
