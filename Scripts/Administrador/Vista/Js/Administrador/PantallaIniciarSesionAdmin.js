...
class PantallaLogin {
    ...
    agregarEventListeners() {
        ...
        togglePassword.addEventListener("click", () => {
            ...
            togglePassword.innerHTML = visible ? ojoCerrado : ojoAbierto;
        });
    ...
    async manejarLogin(event) {
        ...
        try {
            const loginExitoso = await this.gestor.loguearAdministrador(nombre, contrasena);
            ...
            this.mensajeError.textContent = 'Los datos ingresados son incorrectos.';
            this.mensajeError.classList.remove('hidden');
        }
    }
}
